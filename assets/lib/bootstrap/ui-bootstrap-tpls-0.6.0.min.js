 ...
 */
  .directive('modalBackdrop', ['$modalStack', '$timeout', '$document', function ($modalStack, $timeout, $document) {
    return {
      restrict: 'EA',
      replace: true,
      ...
      link: function (scope, element, attrs) {
        ...
        scope.close = function (evt) {
          ...
          if (modal && modal.value.backdrop && modal.value.backdrop != 'static') {
            evt.preventDefault();
            evt.stopPropagation();
   			    $document[0].body.className = null;
  ...
  .directive('modalWindow', ['$modalStack', '$timeout', '$document', function ($modalStack, $timeout, $document)  {
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        scope.close = function (evt) {
          if ((evt.target.id.trim().toLowerCase() == "modal-dialog") ||
          (evt.target.id.trim().toLowerCase() == "add-song-container") ||
          (evt.target.id.trim().toLowerCase() == "search-song-container") ||
          (evt.target.id.trim().toLowerCase() == "add-details-container")) {
            var modal = $modalStack.getTop();
            if (modal && modal.value.backdrop && modal.value.backdrop != 'static') {
              evt.preventDefault();
              evt.stopPropagation();
  ...
  .provider('$modal', function () {
    ...
    var $modalProvider = {
      ...
      $get: ['$injector', '$rootScope', '$q', '$http', '$templateCache', '$controller', '$document', '$modalStack',
        function ($injector, $rootScope, $q, $http, $templateCache, $controller, $document, $modalStack) {
...
angular.module("template/modal/window.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/modal/window.html",
    "<div id=\"modal-dialog\" class=\"modal fade {{ windowClass }}\" ng-class=\"{in: animate}\" ng-style=\"{'z-index': 1050 + index*10}\" ng-transclude ng-click=\"close($event)\"></div>");
}]);
